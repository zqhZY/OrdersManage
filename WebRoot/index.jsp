				...
				<div class="section group">
					...
					<c:forEach items="${items }" var="item">
						...
						<div class="grid_1_of_5 images_1_of_5">
							<a href="${pageContext.request.contextPath}/items/preview.action?id=${item.id }"> <img
								src="${pageContext.request.contextPath}/${item.pic }" alt="" /> </a>
							<h2>
							...
							<div class="price-details">
								...
								<div class="add-cart">
									<h4>
										<a href="${pageContext.request.contextPath}/items/preview.action?id=${item.id }">Add to Cart</a>
									</h4>
								</div>
								<div class="clear"></div>
							</div>
